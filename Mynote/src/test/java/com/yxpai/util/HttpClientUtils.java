...
public class HttpClientUtils {
	...
	public static void main(String arg[]) throws Exception {
		String url = "http://www.wikinote.net/";
		// getDoGetURL2(url,"utf-8");//测试ok
		// getDoGetURL(url,"utf-8");//测试ok
		getDoPostResponseDataByURL(url, null, "utf-8"); // 测试ok
	}
	 ...
	 * @return 返回请求响应的HTML
	 */
	public static String getDoPostResponseDataByURL(String url,Map<String, String> params, String charset) {
