...
<div id="msg" class="errors">
  ...
  <div class="box fl-panel" id="login">
            ...
            <br/>
            <a id="WeiboProviderUrl" href="${WeiboProviderUrl}">weibo</a><br/>
			<a id="QQProviderUrl" href="${QQProviderUrl}">qq</a><br/>
			<a id="CasWrapperProvider20Url" href="${CasWrapperProvider20Url}">CasWrapperProvider20</a>
          </div>
            <div id="sidebar">
