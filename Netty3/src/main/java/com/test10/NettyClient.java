...
public class NettyClient {  
    ...
    private ClientObjectHandler handler;  
 ...
 */  
    public void init() {  
        ...
        bootstrap.setPipelineFactory(new ChannelPipelineFactory() {  
            public ChannelPipeline getPipeline() throws Exception {  
                ...
                channelPipeline.addLast("decode", new ObjectDecoder(ClassResolvers.cacheDisabled(this.getClass().getClassLoader()))); 
    ...
    public void setHandler(ClientObjectHandler handler) {  
    ...
    public ClientObjectHandler getHandler() {  
        return handler;  
    }  
